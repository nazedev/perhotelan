...
<head>
    ...
    <title>Daftar Admin - Hotel Management System</title>
...
<body>
    <div class="auth-wrapper">
        <div class="auth-card">
            <h2 class="auth-title"><i class="fas fa-user-plus"></i> Daftar Admin</h2>
            ...
            <div style="text-align: center; margin-top: 1.5rem;">
                ...
                <a href="login.php" style="font-weight: 500;">Login di sini</a>
            </div>
